...
# Add sources
#-------------------------------------------------------------------
set (sourcepath ../srofs/)
add_source(sr_rofs.cpp dircache.cpp)
add_source(erofs_uid.cpp)
...
#-------------------------------------------------------------------
get_source(source)
add_library (erofs SHARED ${source})
target_link_libraries(	erofs 
						edll efile efsrv euser
						) 
set_target_properties(erofs PROPERTIES SUFFIX ".fsy")
set_target_properties(erofs PROPERTIES LINK_FLAGS "/INCLUDE:__E32Dll")
#set_target_properties(erofs PROPERTIES LINK_FLAGS "/INCLUDE:_DllMain")
