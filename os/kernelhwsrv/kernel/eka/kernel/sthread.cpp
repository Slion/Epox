...
//
	...
	if (KDebugNum(KCRAZYSCHEDDELAY))
		{
		//SL: This appears to help with our __NK_ASSERT_ALWAYS(!me.iDiverted) crashes
		//Having a delay of 2 ticks does not hit our FPS more than with 1 tick. Consider it if still having problems.
		NKern::Sleep(1);
		}
