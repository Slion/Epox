...
RHeap* hhh = (RHeap*)Dll::Tls();
fTableCache = (FontTableCacheEntry *)hhh->Alloc(sizeof(FontTableCacheEntry)*(fTableCacheSize));
...
FontTableCache::~FontTableCache()
{
    ...
    fTableCacheCurr = 0;
RHeap* hhh = (RHeap*)Dll::Tls();
hhh->Free(fTableCache);
//    delete fTableCache; //Jas 23/06/2005
}
