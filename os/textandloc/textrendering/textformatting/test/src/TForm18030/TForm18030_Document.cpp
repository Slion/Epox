...
// document class - TForm18030_Document
//
////////////////////////////////////////////////////////////////////////
...
//
TForm18030_Document::TForm18030_Document(CEikApplication& aApp)
		: CEikDocument(aApp)
	{
	}
...
//
CEikAppUi* TForm18030_Document::CreateAppUiL()
	{
    return new(ELeave) TForm18030_AppUi;
	}
