...
CSymmetricMacIncrementalResetStep::~CSymmetricMacIncrementalResetStep()
	{
	}
...
CSymmetricMacIncrementalResetStep::CSymmetricMacIncrementalResetStep()
	{
	SetTestStepName(KSymmetricMacIncrementalResetStep);
	}


TVerdict CSymmetricMacIncrementalResetStep::doTestStepPreambleL()
	{
	return EPass;
	}


TVerdict CSymmetricMacIncrementalResetStep::doTestStepL()
	{
	//Assume faliure, unless all is successful
	SetTestStepResult(EFail);

	INFO_PRINTF1(_L("*** Symmetric Mac - Incremental with Reset ***"));
...
TVerdict CSymmetricMacIncrementalResetStep::doTestStepPostambleL()
	{
	return TestStepResult();
	}
