...
CHashIncrementalHashStep::~CHashIncrementalHashStep()
	{
	}
...
CHashIncrementalHashStep::CHashIncrementalHashStep()
	{
	SetTestStepName(KHashIncrementalHashStep);
	}


TVerdict CHashIncrementalHashStep::doTestStepPreambleL()
	{
...
TVerdict CHashIncrementalHashStep::doTestStepL()
	{
	if (TestStepResult()==EPass)
		...
		INFO_PRINTF1(_L("*** Hash - Incremental Hash ***"));
...
TVerdict CHashIncrementalHashStep::doTestStepPostambleL()
	{
	return TestStepResult();
	}
