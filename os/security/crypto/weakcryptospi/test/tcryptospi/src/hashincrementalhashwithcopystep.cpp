...
CHashIncrementalHashWithCopyStep::~CHashIncrementalHashWithCopyStep()
	{
	}
...
CHashIncrementalHashWithCopyStep::CHashIncrementalHashWithCopyStep()
	{
	SetTestStepName(KHashIncrementalHashWithCopyStep);
	}


TVerdict CHashIncrementalHashWithCopyStep::doTestStepPreambleL()
	{
...
TVerdict CHashIncrementalHashWithCopyStep::doTestStepPostambleL()
	{
