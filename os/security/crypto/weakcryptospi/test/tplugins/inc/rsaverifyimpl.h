...
namespace SoftwareCrypto
	...
	public:
		...
		*/
		static CRSAVerifierImpl* NewL(TUid aImplementationUid, const CKey& aKey, TUid aPaddingMode);
		...
		@return A pointer to a CRSAVerifierImpl instance
		*/
		static CRSAVerifierImpl* NewLC(TUid aImplementationUid, const CKey& aKey, TUid aPaddingMode);
	...
	protected:
		/// Constructor
		CRSAVerifierImpl(TUid aImplementationUid, TUid aPaddingMode);
