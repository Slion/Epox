...
%SECURITYSOURCEDIR%\testframework\test\autotesting\test_launcher.pl -components crypto,cryptospi -testreleases udeb -exectimeout \ExecTimeOut.exe -resultsoutput \logs\winscw
)
