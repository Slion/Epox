...
#ifndef __FEATMGRNORMALPLUGIN_H_
#define __FEATMGRNORMALPLUGIN_H_

#include "baseplugin.h"
#include <featmgr/featureinfoplugin.h>


class CFeatMgrInvalidPlugin : public CFeatMgrBasePlugin
    {
    public:

        static CFeatMgrInvalidPlugin* NewL();
        virtual ~CFeatMgrInvalidPlugin();
    ...
    private: // Construction
        ...
        CFeatMgrInvalidPlugin();
        void ConstructL();

    };

#endif // __FEATMGRNORMALPLUGIN_H_
