...
** Open a blob handle.
*/
SQLITE_EXPORT int sqlite3_blob_open(
...
** sqlite3_blob_open().
*/
SQLITE_EXPORT int sqlite3_blob_close(sqlite3_blob *pBlob){
...
*/
SQLITE_EXPORT int sqlite3_blob_read(sqlite3_blob *pBlob, void *z, int n, int iOffset){
...
*/
SQLITE_EXPORT int sqlite3_blob_write(sqlite3_blob *pBlob, const void *z, int n, int iOffset){
...
*/
SQLITE_EXPORT int sqlite3_blob_bytes(sqlite3_blob *pBlob){
  Incrblob *p = (Incrblob *)pBlob;
  return p->nByte;
}
