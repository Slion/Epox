...
//
// Description:
// This file defines all common values throughout the test project
// 
//

#if !defined(__PCSTORETESTDEF_H__)
#define __PCSTORETESTDEF_H__

// namespace in PC platform
#ifndef __WINSCW__
...
const TInt64 KRefTInt64 = -1152921504606846976ll; // -0x1000000000000000
const TUint64 KRefTUint64 = 1152921504606846976ull; // 0x1000000000000000
const TUid KRefTUid={65};

// Boundary numbers for the cardinality testing
// Cardinality takes
// 1 byte to represent number 0 - 63;
// 2 bytes to represent number 64 - 8191;
// 4 bytes to represent number 8192 and above;
#define CARDINAL_1_BYTE_START 0
#define CARDINAL_1_BYTE_END	 63
#define CARDINAL_2_BYTES_START 64
#define CARDINAL_2_BYTES_END 8191
#define CARDINAL_4_BYTES_START 8192

// Characters to form the 8-bit reference descriptor.
// The test needs a 8-bit descriptor with the length of 8192. To avoid the program stack being 
// huge, we will appended this characters array to the 16-bit descriptor a fews times to make 
// its length more than 8192.
...
// Unicode characters to form the 16-bit reference descriptor.
// For a wide coverage, they include ASCII, Arabic, Chinese
// The test needs a 16-bit descriptor with the length of 8192. To avoid the program stack being 
// huge, we will appended this characters array to the 16-bit descriptor a few times to make its 
// length more than 8192.
...
const TInt32 KRefData8Size = sizeof(RefData8) / sizeof(RefData8[0]);
const TInt32 KRefDataUnicodeSize = sizeof(RefDataUnicode) / sizeof(RefDataUnicode[0]);


// Different descriptor implementations for Symbian and PC programs 
#ifdef __WINSCW__
const TPtrC8 KRefText8(RefData8, KRefData8Size) ;
const TPtrC16 KRefText16(RefDataUnicode, KRefDataUnicodeSize);
#else
const CDes8 KRefText8(RefData8, KRefData8Size);
const CDes16 KRefText16(RefDataUnicode,KRefDataUnicodeSize);
#endif

#endif // !defined(__PCSTORETESTDEF_H__)
