...
/* Doubly linked lists
 */
IMPORT_C GList*   g_list_alloc                   (void) G_GNUC_WARN_UNUSED_RESULT;
...
IMPORT_C GList*   g_list_reverse                 (GList            *list) G_GNUC_WARN_UNUSED_RESULT;
IMPORT_C GList*   g_list_copy                    (GList            *list) G_GNUC_WARN_UNUSED_RESULT;
