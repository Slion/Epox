...
#if EMULATOR
PLS(child_watch_init_state,gmain,gint)
PLS(child_watch_count,gmain,gint)
PLS_ARRAY(child_watch_wake_up_pipe,gmain,gint)

#define child_watch_init_state (*FUNCTION_NAME(child_watch_init_state,gmain)())
#define child_watch_count (*FUNCTION_NAME(child_watch_count,gmain)())
#define child_watch_wake_up_pipe (FUNCTION_NAME(child_watch_wake_up_pipe,gmain)())
#else
...
#define timer_perturb (*FUNCTION_NAME(timer_perturb,gmain)())
#else
...
#ifdef __SYMBIAN32__
EXPORT_C GSourceFuncs * _g_timeout_funcs(void)
{
	return &g_timeout_funcs;
}

EXPORT_C GSourceFuncs * _g_idle_funcs(void)
{
	return &g_idle_funcs;
}

EXPORT_C GSourceFuncs * _g_child_watch_funcs(void)
{
...
PLS(depth_private,get_dispatch ,GStaticPrivate)
#define depth_private (*FUNCTION_NAME(depth_private,get_dispatch )())
...
g_child_watch_check (GSource  *source)
{
  ...
  return check_for_child_exited (child_watch_source->pid);//review
}
