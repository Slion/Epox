...
#endif
#if EMULATOR
PLS(g_thread_gettime,gthread,function_type)
#define g_thread_gettime (*FUNCTION_NAME(g_thread_gettime,gthread)())
#else
guint64        (*g_thread_gettime) (void) = gettime;
#endif//EMULATOR
#ifdef __SYMBIAN32__
EXPORT_C gettimetype *_g_thread_gettime()
	{
	return &g_thread_gettime;
	}
#endif//__SYMBIAN32__
/* Global variables */
...
#ifdef __SYMBIAN32__
EXPORT_C gboolean *_g_thread_use_default_impl(void)
{
	return &g_thread_use_default_impl;
}

EXPORT_C gboolean *_g_threads_got_initialized(void)
{
	return &g_threads_got_initialized;
}

EXPORT_C GThreadFunctions *_g_thread_functions_for_glib_use(void)
{
	return &g_thread_functions_for_glib_use;
}

EXPORT_C gboolean g_thread_supported (void)
{
	return g_threads_got_initialized;
}
...
PLS(g_once_init_list,gthread,GSList *)
...
#define g_once_init_list (*FUNCTION_NAME(g_once_init_list,gthread)())
