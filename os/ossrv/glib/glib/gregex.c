...
PLS(error_quark ,g_regex_error_quark,GQuark)
#define error_quark  (*FUNCTION_NAME(error_quark,g_regex_error_quark)())
...
PLS(initialized ,g_regex_new,gboolean)
#define initialized  (*FUNCTION_NAME(initialized ,g_regex_new)())
