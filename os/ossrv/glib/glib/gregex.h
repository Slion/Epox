...
IMPORT_C GRegex		 *g_regex_new			(const gchar         *pattern,
						 ...
						 GError             **error);
IMPORT_C GRegex           *g_regex_ref			(GRegex              *regex);
IMPORT_C void		  g_regex_unref			(GRegex              *regex);
IMPORT_C const gchar	 *g_regex_get_pattern		(const GRegex        *regex);
IMPORT_C gint		  g_regex_get_max_backref	(const GRegex        *regex);
IMPORT_C gint		  g_regex_get_capture_count	(const GRegex        *regex);
IMPORT_C gint		  g_regex_get_string_number	(const GRegex        *regex, 
						 const gchar         *name);
IMPORT_C gchar		 *g_regex_escape_string		(const gchar         *string,
						 gint                 length);
