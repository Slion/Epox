...
IMPORT_C gboolean             g_markup_parse_context_parse (GMarkupParseContext *context,
                                                   ...
                                                   gssize               text_len,  
                                                   GError             **error);
IMPORT_C void                 g_markup_parse_context_push  (GMarkupParseContext *context,
                                                   GMarkupParser       *parser,
                                                   gpointer             user_data);
IMPORT_C gpointer             g_markup_parse_context_pop   (GMarkupParseContext *context);
...
IMPORT_C void                 g_markup_parse_context_get_position (GMarkupParseContext *context,
                                                          gint                *line_number,
                                                          gint                *char_number);
IMPORT_C gpointer             g_markup_parse_context_get_user_data (GMarkupParseContext *context);
...
IMPORT_C gboolean   g_markup_collect_attributes (const gchar         *element_name,
                                        const gchar        **attribute_names,
                                        const gchar        **attribute_values,
                                        GError             **error,
