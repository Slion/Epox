...
PLS(smc_tree_mutex,gslice,GMutex *)
...
#define smc_tree_mutex  (*FUNCTION_NAME(smc_tree_mutex ,gslice)())
#else
...
static SliceConfig slice_config = {
  ...
  FALSE,        /* debug_blocks */
  15 * 1000,    /* working_set_msecs *//*use 0 for testing*/
...
PLS(single_thread_memory,gslice,ThreadMemory *)
#define single_thread_memory  (*FUNCTION_NAME(single_thread_memory,gslice)())
...
//coverity[symbian.cleanup_stack]
...
PLS(smc_tree_root,gslice,SmcBranch **)
#define smc_tree_root  (*FUNCTION_NAME(smc_tree_root,gslice)())
