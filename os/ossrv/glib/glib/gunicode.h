...
IMPORT_C gboolean g_unichar_iswide_cjk(gunichar c) G_GNUC_CONST;
IMPORT_C gboolean g_unichar_iszerowidth(gunichar c) G_GNUC_CONST;
IMPORT_C gboolean g_unichar_ismark    (gunichar c) G_GNUC_CONST;
...
IMPORT_C gint g_unichar_combining_class (gunichar uc) G_GNUC_CONST;
 ...
 */
#ifdef __SYMBIAN32__
IMPORT_C const gchar * const * _g_utf8_skip(void);
#endif /* __SYMBIAN32__ */
GLIB_VAR const gchar * const g_utf8_skip;

#define g_utf8_next_char(p) (char *)((p) + g_utf8_skip[*(guchar *)(p)])

IMPORT_C gunichar g_utf8_get_char           (const gchar  *p) G_GNUC_PURE;
...
IMPORT_C gchar*   g_utf8_prev_char         (const gchar *p) G_GNUC_PURE;
...
IMPORT_C gboolean g_unichar_validate (gunichar ch) G_GNUC_CONST;
...
IMPORT_C GUnicodeScript g_unichar_get_script (gunichar ch) G_GNUC_CONST;
