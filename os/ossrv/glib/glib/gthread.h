...
typedef guint64 (*gettimetype)(void);
#ifdef __SYMBIAN32__
...
IMPORT_C gboolean                g_once_init_enter_impl  (volatile gsize *value_location);
IMPORT_C void                    g_once_init_leave       (volatile gsize *value_location,
