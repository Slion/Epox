...
#ifndef __PLATSECRESOLVER_H__
#define __PLATSECRESOLVER_H__
 ...
 */
class CPlatSecResolver : public CResolver
{
public:
/**
	...
	@post			CPlatSecResolver is fully constructed, 
					and initialized.
 */
	static CPlatSecResolver* NewL(MPublicRegistry& aRegistry);
...
/**
	@internalComponent
	@fn				CPlatSecResolver(MPublicRegistry& aRegistry)
	Intended Usage	: Standardized default c'tor	
	Error Condition	: None	
	@since			7.0
	@post			CPlatSecResolver is fully constructed
 */
	explicit CPlatSecResolver(MPublicRegistry& aRegistry);
