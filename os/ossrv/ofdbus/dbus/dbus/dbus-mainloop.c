                      ...
                      DBusFreeFunction     free_data_func)
{
  ...
  cb->function = function;
  #ifdef __SYMBIAN32__
  _dbus_get_current_time ((long *) &cb->last_tv_sec,
                          (long *)&cb->last_tv_usec);
#else
...
#if defined(DBUS_BUILD_TESTS) && defined(__SYMBIAN32__)
EXPORT_C
#endif
DBusLoop*
_dbus_loop_new (void)
...
#else      
      _dbus_get_current_time ((long*)&tv_sec,(long *) &tv_usec);
#endif
