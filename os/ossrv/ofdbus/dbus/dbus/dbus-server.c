...
#if EMULATOR
GET_STATIC_VAR_FROM_TLS(slot_allocator,dbus_server,DBusDataSlotAllocator)
#define slot_allocator (*GET_DBUS_WSD_VAR_NAME(slot_allocator,dbus_server,s)())
#else
static DBusDataSlotAllocator slot_allocator;
#endif
#if EMULATOR
GET_GLOBAL_VAR_FROM_TLS(_dbus_lock_server_slots,dbus_server,DBusMutex *)
