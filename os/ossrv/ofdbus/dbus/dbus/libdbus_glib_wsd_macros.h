...
#ifndef _LIBDBUS_GLIB_WSD_DEFS_H_
#define _LIBDBUS_GLIB_WSD_DEFS_H_
...
#define RETURN_WSD_VAR(var,filename,prefix) (libdbus_glib_ImpurePtr()->GET_DBUS_WSD_VAR_NAME(var,filename,prefix))
