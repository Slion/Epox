...
#else  
p = (const unsigned char*) _dbus_string_get_const_data_len (type_str, type_pos, 0);
end = (const unsigned char*) _dbus_string_get_const_data_len (type_str, type_pos + len, 0);
#endif
...
#ifdef __SYMBIAN32__
  p = (const unsigned char *) _dbus_string_get_const_data_len (value_str, value_pos, len);
#else
...
#ifdef __SYMBIAN32__
  s = (const unsigned char *) _dbus_string_get_const_data (str) + start;
#else
                          ...
                          int                len)
{
  ...
  last_dot = NULL;
#ifdef __SYMBIAN32__
  iface = (const unsigned char *) _dbus_string_get_const_data (str) + start;
#else
...
#ifdef __SYMBIAN32__
  member = (const unsigned char *) _dbus_string_get_const_data (str) + start;
#else
