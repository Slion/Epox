...
#ifdef __SYMBIAN32__
IMPORT_C char * symbian_dbus_no_memory_message(void);
#define _dbus_no_memory_message (symbian_dbus_no_memory_message())
#define _DBUS_SET_OOM(error) dbus_set_error_const ((error), DBUS_ERROR_NO_MEMORY, (symbian_dbus_no_memory_message()))
#else
...
#endif
//extern int _g_dbus_memory__dbus_current_generation;
//#endif
/* Thread initializers */
