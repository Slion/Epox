 ...
 */
#if EMULATOR
GET_STATIC_VAR_FROM_TLS(list_pool,dbus_list,DBusMemPool *)
#define list_pool (*GET_DBUS_WSD_VAR_NAME(list_pool,dbus_list,s)())
#else
static DBusMemPool *list_pool;
#endif
#if EMULATOR
GET_GLOBAL_VAR_FROM_TLS(_dbus_lock_list,dbus_list,DBusMutex *)
