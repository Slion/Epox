...
#if EMULATOR
GET_STATIC_VAR_FROM_TLS(debug_initialized,dbus_memory,dbus_bool_t)
GET_STATIC_VAR_FROM_TLS(fail_nth,dbus_memory,int)
GET_STATIC_VAR_FROM_TLS(fail_size,dbus_memory,size_t)
GET_STATIC_VAR_FROM_TLS(fail_alloc_counter,dbus_memory,int)
GET_STATIC_VAR_FROM_TLS(n_failures_per_failure,dbus_memory,int)
GET_STATIC_VAR_FROM_TLS(n_failures_this_failure,dbus_memory,int)
GET_STATIC_VAR_FROM_TLS(guards,dbus_memory,dbus_bool_t)
GET_STATIC_VAR_FROM_TLS(disable_mem_pools,dbus_memory,dbus_bool_t)
GET_STATIC_VAR_FROM_TLS(backtrace_on_fail_alloc,dbus_memory,dbus_bool_t)
GET_STATIC_VAR_FROM_TLS(n_blocks_outstanding,dbus_memory,DBusAtomic)

#define debug_initialized (*GET_DBUS_WSD_VAR_NAME(debug_initialized,dbus_memory,s)())
#define fail_nth (*GET_DBUS_WSD_VAR_NAME(fail_nth,dbus_memory,s)())
#define fail_size (*GET_DBUS_WSD_VAR_NAME(fail_size,dbus_memory,s)())
#define fail_alloc_counter (*GET_DBUS_WSD_VAR_NAME(fail_alloc_counter,dbus_memory,s)())
#define n_failures_per_failure (*GET_DBUS_WSD_VAR_NAME(n_failures_per_failure,dbus_memory,s)())
#define n_failures_this_failure (*GET_DBUS_WSD_VAR_NAME(n_failures_this_failure,dbus_memory,s)())
#define guards (*GET_DBUS_WSD_VAR_NAME(guards,dbus_memory,s)())
#define disable_mem_pools (*GET_DBUS_WSD_VAR_NAME(disable_mem_pools,dbus_memory,s)())
#define backtrace_on_fail_alloc (*GET_DBUS_WSD_VAR_NAME(backtrace_on_fail_alloc,dbus_memory,s)())
#define n_blocks_outstanding (*GET_DBUS_WSD_VAR_NAME(n_blocks_outstanding,dbus_memory,s)())
...
#if EMULATOR
GET_GLOBAL_VAR_FROM_TLS(_dbus_current_generation,dbus_memory,int)
...
#endif
#if EMULATOR
GET_GLOBAL_VAR_FROM_TLS(_dbus_lock_shutdown_funcs,dbus_memory,DBusMutex *)
...
#endif
#if EMULATOR
GET_STATIC_VAR_FROM_TLS(registered_globals,dbus_memory,ShutdownClosure *)
#define registered_globals (*GET_DBUS_WSD_VAR_NAME(registered_globals,dbus_memory,s)())
#else
