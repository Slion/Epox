...
#else
GET_STATIC_VAR_FROM_TLS(notify_user_data_slot,dbus_pending_call,dbus_int32_t)
#define notify_user_data_slot (*GET_DBUS_WSD_VAR_NAME(notify_user_data_slot,dbus_pending_call,s)())
#endif
...
#if EMULATOR
GET_STATIC_VAR_FROM_TLS(slot_allocator,dbus_pending_call,DBusDataSlotAllocator)
#define slot_allocator (*GET_DBUS_WSD_VAR_NAME(slot_allocator,dbus_pending_call,s)())
#else
static DBusDataSlotAllocator slot_allocator;
#endif
#if EMULATOR
GET_GLOBAL_VAR_FROM_TLS(_dbus_lock_pending_call_slots,dbus_pending_call,DBusMutex *)
