...
#if EMULATOR
GET_STATIC_VAR_FROM_TLS(server_pipe_hash,dbus_server_debug_pipe,DBusHashTable *)
GET_STATIC_VAR_FROM_TLS(server_pipe_hash_refcount,dbus_server_debug_pipe,int)
#define server_pipe_hash (*GET_DBUS_WSD_VAR_NAME(server_pipe_hash,dbus_server_debug_pipe,s)())
#define server_pipe_hash_refcount (*GET_DBUS_WSD_VAR_NAME(server_pipe_hash_refcount,dbus_server_debug_pipe,s)())
#else
...
#if EMULATOR
GET_STATIC_VAR_FROM_TLS(debug_vtable,dbus_server_debug_pipe,DBusServerVTable)
#define debug_vtable (*GET_DBUS_WSD_VAR_NAME(debug_vtable,dbus_server_debug_pipe,s)())
#else
