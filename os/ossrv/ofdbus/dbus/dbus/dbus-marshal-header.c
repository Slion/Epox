...
#ifdef __SYMBIAN32__
  flags_p = (unsigned char *) _dbus_string_get_data_len (&header->data, FLAGS_OFFSET, 1);
#else
...
#else  
  flags_p = (const unsigned char*)_dbus_string_get_const_data_len (&header->data, FLAGS_OFFSET, 1);
#endif
