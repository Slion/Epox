...
#ifndef __LIBDBUS_CONVENIENCE_WSD_MACROS_H__
#define __LIBDBUS_CONVENIENCE_WSD_MACROS_H__
...
#ifdef RETURN_WSD_VAR
#undef RETURN_WSD_VAR
#define RETURN_WSD_VAR(var,filename,prefix) (libdbus_convenience_ImpurePtr()->GET_DBUS_WSD_VAR_NAME(var,filename,prefix))
#endif //RETURN_WSD_VAR
...
#endif
#endif		//__LIBDBUS_CONVENIENCE_WSD_MACROS_H__
