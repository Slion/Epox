...
#if EMULATOR
GET_STATIC_ARRAY_FROM_TLS(thread_functions,dbus_threads,DBusThreadFunctions)
#define thread_functions (*GET_DBUS_WSD_VAR_NAME(thread_functions,dbus_threads,s)())
#else
...
GET_STATIC_VAR_FROM_TLS(thread_init_generation,dbus_threads,int)
#define thread_init_generation (*GET_DBUS_WSD_VAR_NAME(thread_init_generation,dbus_threads,s)())

GET_STATIC_VAR_FROM_TLS(uninitialized_mutex_list,dbus_threads,DBusList*)
#define uninitialized_mutex_list (*GET_DBUS_WSD_VAR_NAME(uninitialized_mutex_list,dbus_threads,s)())

GET_STATIC_VAR_FROM_TLS(uninitialized_condvar_list,dbus_threads,DBusList*)
#define uninitialized_condvar_list (*GET_DBUS_WSD_VAR_NAME(uninitialized_condvar_list,dbus_threads,s)())
#endif
...
#if EMULATOR
 DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_bus,dbus_bus,g)();
#define _dbus_lock_bus (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_bus,dbus_bus,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_bus_datas,dbus_bus,g)();
#define _dbus_lock_bus_datas (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_bus_datas,dbus_bus,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_shared_connections,dbus_connection,g)();
#define _dbus_lock_shared_connections (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_shared_connections,dbus_connection,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_message_cache,dbus_message,g)();
#define _dbus_lock_message_cache (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_message_cache,dbus_message,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_message_slots,dbus_message,g)();
#define _dbus_lock_message_slots (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_message_slots,dbus_message,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_pending_call_slots,dbus_pending_call,g)();
#define _dbus_lock_pending_call_slots (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_pending_call_slots,dbus_pending_call,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_server_slots,dbus_server,g)();
#define _dbus_lock_server_slots (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_server_slots,dbus_server,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_machine_uuid,dbus_internals,g)();
#define _dbus_lock_machine_uuid (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_machine_uuid,dbus_internals,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_list,dbus_list,g)();
#define _dbus_lock_list (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_list,dbus_list,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_shutdown_funcs,dbus_memory,g)();
#define _dbus_lock_shutdown_funcs (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_shutdown_funcs,dbus_memory,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_atomic,dbus_sysdeps,g)();
#define _dbus_lock_atomic (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_atomic,dbus_sysdeps,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_win_fds,dbus_sysdeps,g)();
#define _dbus_lock_win_fds (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_win_fds,dbus_sysdeps,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_sid_atom_cache,dbus_sysdeps,g)();
#define _dbus_lock_sid_atom_cache (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_sid_atom_cache,dbus_sysdeps,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_connection_slots,dbus_connection,g)();
#define _dbus_lock_connection_slots (*GET_DBUS_WSD_VAR_NAME(_dbus_lock_connection_slots,dbus_connection,g)())

DBusMutex  * GET_DBUS_WSD_VAR_NAME(_dbus_lock_system_users,dbus_userdb,g)();
