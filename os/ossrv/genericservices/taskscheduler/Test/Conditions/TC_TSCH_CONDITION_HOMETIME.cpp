...
_LIT(KTestName,	"Task Scheduler Condition Scheduling Test - Hometime");
...
static TInt CreateScheduleSingle1L(TSchedulerItemRef& aRef, 
	...
	TTime ttime(SchSvrHelpers::TimeBasedOnOffset(0, 0, 0, 0, 0, 1));
	TTsTime time(ttime, EFalse); //1 year in the future
...
/**
@file
@SYMTestCaseID				SYSLIB-SCHSVR-CT-0241
@SYMTestCaseDesc 			Single condition based test - Hometime
...
static void DoTest1L()
	{
	TheTest.Next(_L(" @SYMTestCaseID:SYSLIB-SCHSVR-CT-0241 "));
...
/**
@file
@SYMTestCaseID				SYSLIB-SCHSVR-CT-0242
@SYMTestCaseDesc 			Multiple condition based test - Hometime
@SYMTestPriority 			High
...
static void DoTest2L()
	{
	TheTest.Next(_L(" @SYMTestCaseID:SYSLIB-SCHSVR-CT-0242 "));
...
/**
@file
@SYMTestCaseID				SYSLIB-SCHSVR-CT-0243
@SYMTestCaseDesc 			Error checking test - Hometime
@SYMTestPriority 			High
...
static void DoTest3L()	
	{
	TheTest.Next(_L(" @SYMTestCaseID:SYSLIB-SCHSVR-CT-0243 "));
	// create a simple condition based schedule, and see if it runs.
	TInt res = KErrNone;
...
/**
@SYMTestCaseID          SYSLIB-SCHSVR-CT-3246
...
static void DoTest4L()
	{
	TheTest.Next(_L(" @SYMTestCaseID:SYSLIB-SCHSVR-CT-3246 "));
...
GLDEF_C TInt E32Main()
    {
	__UHEAP_MARK;
	TheTest.Start(_L("TC_TSCH_CONDITION_HOMETIME"));
	TheTest.Title();
