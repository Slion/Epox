...
STaskSemaphore sem10;

CDEF061595_Step::~CDEF061595_Step()
/**
 * Destructor
 */
	{
 ...
 */
	...
	SetTestStepName(KDEF061595_Step);
	}

TVerdict CDEF061595_Step::doTestStepPreambleL()
/**
 ...
 */
	...
	User::LeaveIfError(RProperty::Define(KTestUid, KTestKey8, 0));
...
@SYMDEF						DEF061595
*/
TVerdict CDEF061595_Step::doTestStepL()
/**
 * @return - TVerdict code
 ...
 */
	...
	_LIT(KTestName1, "DEF061595 - Time-Based");
	_LIT(KTaskData1, "This is some really exciting task data (number 1)");
	_LIT(KTestName2, "DEF061595 - Condition-Based");
	...
	// This step is identical to the hometime_floatStep except for the schedules
	// being enabled BEFORE the time is changed in this case. As would be normal behaviour
...
TVerdict CDEF061595_Step::doTestStepPostambleL()
/**
 * @return - TVerdict code
 * Override of base class virtual
 */
