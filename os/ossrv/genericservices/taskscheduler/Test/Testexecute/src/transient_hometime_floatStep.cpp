...
Ctransient_hometime_floatStep::~Ctransient_hometime_floatStep()
/**
 * Destructor
 */
	{
 ...
 */
	...
	SetTestStepName(Ktransient_hometime_floatStep);
	}

TVerdict Ctransient_hometime_floatStep::doTestStepPreambleL()
/**
 ...
 */
	...
	User::LeaveIfError(RProperty::Define(KTestUid, KTestKey6, 0));
...
@SYMPREQ					PREQ234
*/
TVerdict Ctransient_hometime_floatStep::doTestStepL()
/**
 * @return - TVerdict code
 ...
 */
	...
	_LIT(KTestName1, "Transient Hometime Float - Time-Based");
	_LIT(KTaskData1, "This is some really exciting task data (number 1)");
	_LIT(KTestName2, "Transient Hometime Float - Condition-Based");
...
TVerdict Ctransient_hometime_floatStep::doTestStepPostambleL()
/**
 * @return - TVerdict code
 * Override of base class virtual
 */
