...
#ifndef TWIOSTREAMS_H
#define TWIOSTREAMS_H
...
// Logging path
_LIT( KtwiostreamsLogPath, "\\logs\\testframework\\twiostreams\\" ); 
// Log file
_LIT( KtwiostreamsLogFile, "twiostreams.txt" ); 
...
/**
*  Ctwiostreams test class for STIF Test Framework TestScripter.
*  ?other_description_lines
*
*  @lib ?library
*  @since ?Series60_version
*/
NONSHARABLE_CLASS(Ctwiostreams) : public CScriptBase
    {
    public:  // Constructors and destructor
        ...
        */
        static Ctwiostreams* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~Ctwiostreams();
    ...
    private:
        ...
        */
        Ctwiostreams( CTestModuleIf& aTestModuleIf );
