...
struct exception_safety_tester : itest::manager, test_observer {
  ...
  IMPORT_C virtual void        exception_point( const_string file, std::size_t line_num, const_string description );
  IMPORT_C virtual bool        decision_point( const_string file, std::size_t line_num );
  IMPORT_C   virtual unsigned    enter_scope( const_string file, std::size_t line_num, const_string scope_name );
   IMPORT_C virtual void        leave_scope( unsigned enter_scope_point );
   IMPORT_C virtual void        allocated( const_string file, std::size_t line_num, void* p, std::size_t s );
   IMPORT_C virtual void        freed( void* p );

    // test observer interface
   IMPORT_C virtual void        assertion_result( bool passed );
  EXPORT_C  virtual int         priority() { return (std::numeric_limits<int>::max)(); } // we want this observer to run the last
...
EXPORT_C exception_safety_tester::exception_safety_tester( const_string test_name )
