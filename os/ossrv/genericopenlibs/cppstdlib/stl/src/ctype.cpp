...
_STLP_DECLSPEC const ctype_base::mask*
...
_STLP_DECLSPEC ctype<char>::ctype(const ctype_base::mask * __tab, bool __del, size_t __refs) :
  locale::facet(__refs),
  _M_ctype_table(__tab ? __tab : classic_table()),
  _M_delete(__tab && __del)
{}

_STLP_DECLSPEC ctype<char>::~ctype() {
  if (_M_delete)
...
_STLP_DECLSPEC char ctype<char>::do_toupper(char __c) const
{ return (char) _S_upper[(unsigned char) __c]; }
_STLP_DECLSPEC char ctype<char>::do_tolower(char __c) const
{ return (char) _S_lower[(unsigned char) __c]; }
_STLP_DECLSPEC const char* ctype<char>::do_toupper(char* __low, const char* __high) const {
  for ( ; __low < __high; ++__low)
    *__low = (char) _S_upper[(unsigned char) *__low];
  return __high;
}
_STLP_DECLSPEC const char* ctype<char>::do_tolower(char* __low, const char* __high) const {
  for ( ; __low < __high; ++__low)
...
//----------------------------------------------------------------------
// ctype<wchar_t>
_STLP_DECLSPEC ctype<wchar_t>::ctype(size_t __refs ) : locale::facet(__refs) {}
_STLP_DECLSPEC ctype<wchar_t>::~ctype() {}


_STLP_DECLSPEC bool ctype<wchar_t>::do_is(ctype_base::mask  m, wchar_t c) const {
  const ctype_base::mask * table = ctype<char>::classic_table();
  return _WCharIndex::in_range(c, ctype<char>::table_size) && (m & table[c]);
}

_STLP_DECLSPEC const wchar_t* ctype<wchar_t>::do_is(const wchar_t* low, const wchar_t* high,
...
_STLP_DECLSPEC wchar_t ctype<wchar_t>::do_toupper(wchar_t c) const {
...
_STLP_DECLSPEC wchar_t ctype<wchar_t>::do_tolower(wchar_t c) const {
...
_STLP_DECLSPEC wchar_t ctype<wchar_t>::do_widen(char c) const {
...
_STLP_DECLSPEC char ctype<wchar_t>::do_narrow(wchar_t c, char dfault) const {
  return (unsigned char) c == c ? c : dfault;
}

_STLP_DECLSPEC const wchar_t* ctype<wchar_t>::do_narrow(const wchar_t* low,
                                         const wchar_t* high,
